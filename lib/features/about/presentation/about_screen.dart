          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                _StatBox(value: '60', label: 'Mësime', cs: cs, theme: theme),
                const SizedBox(width: 8),
                _StatBox(value: '261', label: 'Kuize', cs: cs, theme: theme),
                const SizedBox(width: 8),
                _StatBox(
                    value: '214', label: 'Evidenca', cs: cs, theme: theme),
              ],
            ),
          ),
            ...
            child: Column(
              children: [
                ...
                _FeatureRow(
                  ...
                  subtitle: '261 pyetje me shpjegime të detajuara',
                  theme: theme,
                  cs: cs,
                ),
                _Divider(cs: cs),
                _FeatureRow(
                  ...
                  subtitle: '214 ajete Kuranore dhe hadithe me tekst arab',
                  theme: theme,
                  cs: cs,
                ),
                _Divider(cs: cs),
