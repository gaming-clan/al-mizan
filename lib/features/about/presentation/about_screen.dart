          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                _StatBox(value: '70', label: 'Mësime', cs: cs, theme: theme),
                const SizedBox(width: 8),
                _StatBox(value: '316', label: 'Kuize', cs: cs, theme: theme),
                const SizedBox(width: 8),
                _StatBox(
                    value: '268', label: 'Evidenca', cs: cs, theme: theme),
              ],
            ),
          ),
            ...
            child: Column(
              children: [
                ...
                _FeatureRow(
                  ...
                  subtitle: '316 pyetje me shpjegime të detajuara',
                  theme: theme,
                  cs: cs,
                ),
                _Divider(cs: cs),
                _FeatureRow(
                  ...
                  subtitle: '268 ajete Kuranore dhe hadithe me tekst arab',
                  theme: theme,
                  cs: cs,
                ),
                _Divider(cs: cs),
