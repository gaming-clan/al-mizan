      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                _StatBox(value: '13', label: 'Module', cs: cs, theme: theme),
                const SizedBox(width: 8),
                _StatBox(value: '69', label: 'Mësime', cs: cs, theme: theme),
                const SizedBox(width: 8),
                _StatBox(value: '308', label: 'Kuize', cs: cs, theme: theme),
                const SizedBox(width: 8),
                _StatBox(
                    value: '256', label: 'Evidenca', cs: cs, theme: theme),
              ],
            ),
          ),
            ...
            child: Column(
              children: [
                ...
                _FeatureRow(
                  ...
                  subtitle: '308 pyetje me shpjegime të detajuara',
                  theme: theme,
                  cs: cs,
                ),
                _Divider(cs: cs),
                _FeatureRow(
                  ...
                  subtitle: '256 ajete Kuranore dhe hadithe me tekst arab',
                  theme: theme,
                  cs: cs,
                ),
                _Divider(cs: cs),
                ...
                _FeatureRow(
                  ...
                  title: 'Sfida me Kohë, Ditore dhe Javore',
                  subtitle:
                      'Kuize me kohëmatës dhe seri ditore e javore (streak)',
                  theme: theme,
                  cs: cs,
                ),
                _Divider(cs: cs),
                _FeatureRow(
                  ...
                  title: 'Njoftim Ditor',
                  subtitle:
                      'Thënie dijetarësh çdo ditë — ora e konfigurueshme',
                  theme: theme,
                  cs: cs,
                ),
                _Divider(cs: cs),
          ...
          _InfoCard(
            ...
            child: Column(
              children: [
                ...
                _TechRow(
                    name: 'share_plus · gal',
                    detail: 'Ndarja dhe ruajtja e statistikave',
                    theme: theme,
                    cs: cs),
              ],
            ),
          ...
          _InfoCard(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _SourceRow('Komuniteti Mysliman i Shqipërisë',
                    'E Drejta Islame I, II, III (Stamboll 2013)',
                    theme, cs),
                _Divider(cs: cs),
                _SourceRow('Dr. Jusuf el-Kardavi',
                    'Hallalli dhe Harami në Islam (Shkup 1998)',
                    theme, cs),
                _Divider(cs: cs),
                _SourceRow('Shejh M. Nasirud-din el-Albani',
                    'Forma e Namazit të të Dërguarit', theme, cs),
                _Divider(cs: cs),
                _SourceRow('Imam Abdullah Ibn Baz',
                    'Zhvlerësuesit e Islamit', theme, cs),
                _Divider(cs: cs),
                _SourceRow('Progresi Botime',
                    'Ilmihali — Mësime dhe Rregulla Islame',
                    theme, cs),
                _Divider(cs: cs),
                _SourceRow('Dr. Vehbe ez-Zuhejli',
                    'El-Fikhu el-Islami ve Edil-letuhu', theme, cs),
                _Divider(cs: cs),
                _SourceRow('Dr. Abdul-Azim el-Bedevi',
                    'El-Vexhiz fi Fikhi es-Sunneti ve el-Kitabi el-Aziz',
                    theme, cs),
                _Divider(cs: cs),
                _SourceRow('Ibn Kudame',
                    'El-Mugni', theme, cs),
                _Divider(cs: cs),
                _SourceRow('Sejjid Sabik',
                    'Fikhus-Sunneh', theme, cs),
                _Divider(cs: cs),
                _SourceRow('Imam Buhari',
                    'Sahih el-Buhari (botim shqip)', theme, cs),
                _Divider(cs: cs),
                _SourceRow('Shaban Sulejmani',
                    'E Drejta Penale Islame — pjesa e posaçme', theme, cs),
                _Divider(cs: cs),
                _SourceRow('M. Uthejmin, Ibn Kajjim el-Xhevzije e tjerë',
                    'Esè fikhore bashkëkohore', theme, cs),
              ],
            ),
          ),
